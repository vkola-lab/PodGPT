...
from utils.eval_large_utils import *
...
def evaluation(config, eval_pretrain=False, checkpoint_id=None):
    ...
    medqa_eval(config=config, llm=llm, tokenizer=tokenizer, file_path=file_path, data_path=test_path)
    ...
    os.makedirs(result_dir + "/" + dataset, exist_ok=True)
    file_path = result_dir + "/" + dataset + "/" + checkpoint_path + ".json"
    pubmedqa_eval(config=config, llm=llm, tokenizer=tokenizer, file_path=file_path, data_path=test_path)
    ...
    os.makedirs(result_dir + "/" + dataset, exist_ok=True)
    file_path = result_dir + "/" + dataset + "/" + checkpoint_path + ".json"
    medmcqa_eval(config=config, llm=llm, tokenizer=tokenizer, file_path=file_path, data_path=test_path)
    ...
    os.makedirs(result_dir + "/" + dataset, exist_ok=True)
    file_path = result_dir + "/" + dataset + "/" + checkpoint_path + ".json"
    usmle_eval(config=config, llm=llm, tokenizer=tokenizer, file_path=file_path, data_path=test_path)
    ...
    os.makedirs(result_dir + "/" + dataset, exist_ok=True)
    file_path = result_dir + "/" + dataset + "/" + checkpoint_path + ".json"
    mmlu_eval(config=config, llm=llm, tokenizer=tokenizer, file_path=file_path, data_path=test_path)
    ...
    os.makedirs(result_dir + "/" + dataset, exist_ok=True)
    file_path = result_dir + "/" + dataset + "/" + checkpoint_path + ".json"
    medexpqa_eval(config=config, llm=llm, tokenizer=tokenizer, file_path=file_path, data_path=test_path)
    ...
    os.makedirs(result_dir + "/" + dataset, exist_ok=True)
    file_path = result_dir + "/" + dataset + "/" + checkpoint_path + ".json"
    mcmle_eval(config=config, llm=llm, tokenizer=tokenizer, file_path=file_path, data_path=test_path)
    ...
    os.makedirs(result_dir + "/" + dataset, exist_ok=True)
    file_path = result_dir + "/" + dataset + "/" + checkpoint_path + ".json"
    cmmlu_eval(config=config, llm=llm, tokenizer=tokenizer, file_path=file_path, data_path=test_path)
    ...
    os.makedirs(result_dir + "/" + dataset, exist_ok=True)
    file_path = result_dir + "/" + dataset + "/" + checkpoint_path + ".json"
    frenchmedmcqa_eval(config=config, llm=llm, tokenizer=tokenizer, file_path=file_path, data_path=test_path)
    ...
    os.makedirs(result_dir + "/" + dataset, exist_ok=True)
    file_path = result_dir + "/" + dataset + "/" + checkpoint_path + ".json"
    headqa_eval(config=config, llm=llm, tokenizer=tokenizer, file_path=file_path, data_path=test_path)
