...
from utils.eval_chatgpt_utils import *
...
def evaluation(config):
    ...
    file_path = result_dir + "/" + dataset + "/" + model_name + ".json"
    medqa_eval(config=config, file_path=file_path, data_path=test_path)
    ...
    os.makedirs(result_dir + "/" + dataset, exist_ok=True)
    file_path = result_dir + "/" + dataset + "/" + model_name + ".json"
    pubmedqa_eval(config=config, file_path=file_path, data_path=test_path)
    ...
    os.makedirs(result_dir + "/" + dataset, exist_ok=True)
    file_path = result_dir + "/" + dataset + "/" + model_name + ".json"
    medmcqa_eval(config=config, file_path=file_path, data_path=test_path)
    ...
    os.makedirs(result_dir + "/" + dataset, exist_ok=True)
    file_path = result_dir + "/" + dataset + "/" + model_name + ".json"
    usmle_eval(config=config, file_path=file_path, data_path=test_path)
    ...
    os.makedirs(result_dir + "/" + dataset, exist_ok=True)
    file_path = result_dir + "/" + dataset + "/" + model_name + ".json"
    mmlu_eval(config=config, file_path=file_path, data_path=test_path)
    ...
    os.makedirs(result_dir + "/" + dataset, exist_ok=True)
    file_path = result_dir + "/" + dataset + "/" + model_name + ".json"
    medexpqa_eval(config=config, file_path=file_path, data_path=test_path)
    ...
    os.makedirs(result_dir + "/" + dataset, exist_ok=True)
    file_path = result_dir + "/" + dataset + "/" + model_name + ".json"
    mcmle_eval(config=config, file_path=file_path, data_path=test_path)
    ...
    os.makedirs(result_dir + "/" + dataset, exist_ok=True)
    file_path = result_dir + "/" + dataset + "/" + model_name + ".json"
    cmmlu_eval(config=config, file_path=file_path, data_path=test_path)
    ...
    os.makedirs(result_dir + "/" + dataset, exist_ok=True)
    file_path = result_dir + "/" + dataset + "/" + model_name + ".json"
    frenchmedmcqa_eval(config=config, file_path=file_path, data_path=test_path)
    ...
    os.makedirs(result_dir + "/" + dataset, exist_ok=True)
    file_path = result_dir + "/" + dataset + "/" + model_name + ".json"
    headqa_eval(config=config, file_path=file_path, data_path=test_path)
